...
function Tietoa() {
  return (
    ...
    <div className="rivi">
        ...
        <p>Minä olen Viljami Leskelä vuonna 2006 syntynyt toisen vuoden tieto- ja viestintätekniikan opiskelija OSAO:lla.
        ...
        <div className="box-50">
        <img className="minä" src="/hullukuva.jpg"></img>
        </div>
    </div>
    </section>
    </div>
